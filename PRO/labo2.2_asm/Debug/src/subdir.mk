...
src/cr_startup_lpc176x.o: ../src/cr_startup_lpc176x.c src/subdir.mk
	...
	arm-none-eabi-gcc -D__REDLIB__ -DDEBUG -D__CODE_RED -Os -g3 -Wall -c -fmessage-length=0 -fno-builtin -ffunction-sections -fdata-sections -fmerge-constants -fmacro-prefix-map="$(<D)/"= -mcpu=cortex-m3 -mthumb -D__REDLIB__ -fstack-usage -specs=redlib.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
...
clean-src:
	-$(RM) ./src/assembleur.o ./src/cr_startup_lpc176x.d ./src/cr_startup_lpc176x.o ./src/labo2.2_asm.d ./src/labo2.2_asm.o
